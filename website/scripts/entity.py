    ...
    for key, value in form_data.items():
        if value:
            if key in ["first", "last"]:
                ...
                query_filters.append(f'{key}: {"true" if value.lower() == "true" else "false" if value.lower() == "false" else f\'"{value}"\'}')
